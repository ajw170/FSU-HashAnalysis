...
namespace fsu
{
  ...
  /* Added the default hash class as Kiss, in the event that none is specified
   * by the user client program
   */
  template <typename K, typename D, class H = hashclass::KISS<K>>
  class HashTable
  {
